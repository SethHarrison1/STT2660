---
title: "Project 1--Vectors, Functions, and Data Frames"
author: "Seth Harrison, Baylie Higginbotham, Jamie Baxter"
...
PH <- seq(0, 14, by = .1)
print(PH)
PLAY <- c("rock", "scissors", "paper", "lizard", "Spock")
print(PLAY)
CLOCK <- seq(60, 1, by = -1)
print(CLOCK)
SONG <- rep(c("I get knocked down", "But I get up again", "You're never gonna keep me down"), 2)
print(SONG)
...
sprintf("Spock was played on turn %s", counter)
...
"McCook, Mary E.",
"McCrimmon, Kyera K.",
"Miranda-Hernandez, Daniela P.",
"Nilsson, Connor S.",
"Renko, Anna F.",
"Rodriguez Guzman, Bianca D.",
"Smith, Joel S.",
"Stansberry, Amanda L.",
"Tosto, Christopher H.",
"Tyndall, Matthew B.",
...
email <- c( 
"atwellkl1@appstate.edu",
"bassnw@appstate.edu",
"baxterja@appstate.edu",
"baxtermm@appstate.edu",
"carterna3@appstate.edu",
"danielssb@appstate.edu",
"fennellct@appstate.edu",
"goodmanmm@appstate.edu",
"harrisonsw@appstate.edu",
"haylettec@appstate.edu",
"higginbothamb@appstate.edu",
"leesj3@appstate.edu",
"mccookme@appstate.edu",
"mccrimmonkk@appstate.edu",
"mirandahernandedp@appstate.edu",
"nilssoncs@appstate.edu",
"renkoaf@appstate.edu",
"rodriguezguzmanbd@appstate.edu",
"smithjs5@appstate.edu",
"stansberryal@appstate.edu",
"tostoch@appstate.edu",
"tyndallmb@appstate.edu",
"ugborohu@appstate.edu",
"watkinsam1@appstate.edu",
"whitejd5@appstate.edu"
)
class <- c(
"Senior",
"Junior",
...
dataFrame <- data.frame(Name, preferredName, email, class, college)
str(dataFrame)
head(dataFrame)
tail(dataFrame)
```
